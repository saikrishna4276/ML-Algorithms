...
time1 = time.time()
for i in range(10):
    LR.fit_gradient_descent(X, y, batch_size=1, gradient_type='manual', penalty_type = 'l2', num_iters=10, lr=0.01, penalty_value=0.05)
time2 = time.time()
y_hat = LR.predict(X)
...
time1 = time.time()
for i in range(10):
    LR.fit_gradient_descent(X, y, batch_size=10, gradient_type='manual', penalty_type = 'l2', num_iters=10, lr=0.01, penalty_value=0.05)
time2 = time.time()
y_hat = LR.predict(X)
print("--rmse: ", np.sqrt(mse(y,y_hat)))
print("time taken: ", ((time2-time1)/10))
...
time1 = time.time()
for i in range(10):
    LR.fit_SGD_with_momentum(X, y, gradient_type='manual', penalty_type = 'l2', num_iters=10, lr=0.001, beta=0.05, penalty_value=1.0)
time2 = time.time()
y_hat = LR.predict(X)
print("--rmse: ", np.sqrt(mse(y,y_hat)))
print("time taken: ", ((time2-time1)/10))
